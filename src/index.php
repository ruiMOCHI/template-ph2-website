 <?php
  ...
  ?> <!--questions変数とchoices変数はデータベースのデータを格納するための変数。question変数は選択肢を格納するための配列を作るための変数-->
         ...
         <section class="p-quiz-box js-quiz" data-quiz="<?= $question["id"] ?>">
           <div class="p-quiz-box__question">
             <h2 class="p-quiz-box__question__title">
               <span class="p-quiz-box__label">Q<?= $qkey + 1 ?></span>
               <span class="p-quiz-box__question__title__text"><?= $question["content"]; ?></span>
             </h2>
             <figure class="p-quiz-box__question__image">
               <img src="../assets/img/quiz/img-quiz0<?= $qkey + 1 ?>.png" alt="">
             </figure>
           </div>
           <div class="p-quiz-box__answer">
             <span class="p-quiz-box__label p-quiz-box__label--accent">A</span>
             <ul class="p-quiz-box__answer__list">
               <?php foreach ($question['choices'] as $ckey => $choice) : ?>
                 <li class="p-quiz-box__answer__item">
                   <button class="p-quiz-box__answer__button js-answer" data-valid="<?= $choice["valid"] ?>">
             ...
             <div class="p-quiz-box__answer__correct js-answerBox">
               ...
               <p class="p-quiz-box__answer__correct__content">
                 ...
                 <span class="js-answerText"><?= $question["answer"] ?></span>
               </p>
             </div>
           </div>
           <?php if (!empty($questions[$qkey]["supplement"])) { ?>
             <cite class="p-quiz-box__note">
               <i class="u-icon__note"></i><?= $questions[$qkey]["supplement"]; ?>
             </cite>
           <?php } ?>
         </section>
       <?php endforeach; ?>
